...
const overviewPrecisionDiagram = {
  ...
  nodes: [
    ...
    { x: 435, y: 70, width: 100, height: 32, rx: 7, tone: "is-core" },
    { x: 435, y: 110, width: 100, height: 32, rx: 7, tone: "is-core" },
    { x: 435, y: 150, width: 78, height: 18, rx: 6 },
    { x: 435, y: 176, width: 78, height: 18, rx: 6 },
    { x: 435, y: 202, width: 74, height: 18, rx: 6 },
    { x: 435, y: 228, width: 74, height: 20, rx: 6 },
    { x: 435, y: 254, width: 74, height: 20, rx: 6 },
    { x: 435, y: 280, width: 82, height: 20, rx: 6, tone: "is-main" },
    { x: 435, y: 306, width: 82, height: 20, rx: 6 },
    { x: 435, y: 332, width: 82, height: 20, rx: 6 },
    { x: 435, y: 358, width: 82, height: 20, rx: 6, tone: "is-main" },
    { x: 435, y: 384, width: 82, height: 20, rx: 6 },
    { x: 435, y: 410, width: 82, height: 20, rx: 6 },
...
function PPMPage() {
  ...
  const setFunctions2Feature = useCallback((featureIndex) => {
    ...
    if (
      ...
      imageCardRef2.current.scrollIntoView({
        behavior: "smooth",
        block: "nearest",
      });
      imageCardRef2.current.classList.remove("is-mobile-feedback");
      void imageCardRef2.current.offsetWidth;
      imageCardRef2.current.classList.add("is-mobile-feedback");
      window.setTimeout(() => {
        imageCardRef2.current?.classList.remove("is-mobile-feedback");
      }, 240);
    }
