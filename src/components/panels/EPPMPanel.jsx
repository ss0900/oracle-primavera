...
function EPPMPanel({ id, isActive }) {
  ...
  return (
    <section id={id} ref={sectionRef} className="section eppm-panel">
      <div className="container">
        <div className="eppm-content">
          <div className="eppm-left fade-in-section">
            <span className="product-panel-label">
              Enterprise Project Portfolio Management
            </span>
            <h2 className="product-panel-title">Primavera P6 EPPM</h2>
            <p className="product-panel-description">
              전사 수준의 프로젝트 포트폴리오를 통합 관리하는 엔터프라이즈
              솔루션입니다. 웹 기반 협업, 실시간 모니터링, 고급 분석 기능으로
              조직 전체의 프로젝트 가시성을 확보합니다.
            </p>
